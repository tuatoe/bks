  ...
  return (
    <main className="bks">
      <header>
        ...
        <h2>Empowerment Through Education
</h2>
      </header>
      <nav>
        <ul>
      ...
      <section id="about">
        ...
        <h3>Vision</h3>
        <p>Our vision is to realize a Liberia in which children from all over the country have equal access to quality education in this era of global competitiveness.
      ...
      <section id="how-you-can-help">
        ...
        <h3>Make BKS™ Foundation, Inc. the Charity of Your Choice</h3>
        <p>Talk to your School / College / Church / University / Company to select BKS™ Foundation, Inc. as their charity of choice for donations. To promote our partnership, we will provide you with our organization's logo and merchandise.</p>
      </section>
